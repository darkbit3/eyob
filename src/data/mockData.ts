...
export const mockTransactions: Transaction[] = [
  { id: 't001', userId: 'u002', userName: 'Tigist Bekele', type: 'wallet_deposit', amount: 500, description: 'Wallet deposit via Telebirr', timestamp: '2026-08-08T10:00:00', status: 'completed', paymentMethod: 'Telebirr' },
  ...
  { id: 't003', userId: 'u003', userName: 'Dawit Haile', type: 'wallet_deposit', amount: 100, description: 'Wallet deposit via CBE Birr', timestamp: '2026-08-07T14:30:00', status: 'completed', paymentMethod: 'CBE Birr' },
  ...
  { id: 't005', userId: 'u009', userName: 'Ephrem Tesfaye', type: 'wallet_deposit', amount: 1800, description: 'Wallet deposit via Chapa', timestamp: '2026-08-06T16:20:00', status: 'completed', paymentMethod: 'Chapa' },
  { id: 't006', userId: 'u007', userName: 'Bereket Solomon', type: 'manual_adjustment', amount: 200, description: 'Admin adjustment: Complimentary wallet bonus', timestamp: '2026-08-05T11:00:00', status: 'completed' },
  ...
  { id: 't008', userId: 'u013', userName: 'Tamrat Assefa', type: 'wallet_deposit', amount: 800, description: 'Wallet deposit via Bank Transfer', timestamp: '2026-08-03T11:45:00', status: 'completed', paymentMethod: 'Bank Transfer' },
  { id: 't009', userId: 'u015', userName: 'Natnael Berhane', type: 'wallet_deposit', amount: 450, description: 'Wallet deposit via Telebirr', timestamp: '2026-08-02T15:10:00', status: 'completed', paymentMethod: 'Telebirr' },
...
export const mockAuditLogs: AuditLog[] = [
  ...
  { id: 'log010', adminId: 'u001', adminName: 'Abebe Girma', action: 'Manual Wallet Adjustment', target: 'Bereket Solomon (u007)', details: 'Added +200 ETB wallet bonus (Reason: Promotional bonus)', ipAddress: '197.156.104.12', timestamp: '2026-08-05T11:00:00' },
