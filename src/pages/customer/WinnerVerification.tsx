...
export default function WinnerVerification() {
  ...
  // Fetch ALL bids for this auction from the API (not just current user's bids)
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        ...
        <p className="text-slate-500 text-sm">Loading bid data from database…</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {rawBids.length === 0 && (
        <div className="card text-center py-10 text-slate-400">
          ...
          <p>No bids recorded for this auction.</p>
        </div>
      )}
